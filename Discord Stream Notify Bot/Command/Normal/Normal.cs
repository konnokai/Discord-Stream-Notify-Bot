        ...
        public async Task InviteAsync()
        {
            ...
            try
            {
                await (await Context.Message.Author.CreateDMChannelAsync())
                    .SendConfirmAsync("<https://discordapp.com/api/oauth2/authorize?client_id=" + _client.CurrentUser.Id + "&permissions=1376538291313&scope=bot%20applications.commands>\n");
            }
