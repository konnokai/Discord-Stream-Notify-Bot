...
namespace Discord_Stream_Notify_Bot.Migrations
{
    ...
    [Migration("20250620094111_AddMaxSpiderCountSettingField")]
    partial class AddMaxSpiderCountSettingField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Discord_Stream_Notify_Bot.DataBase.Table.GuildConfig", b =>
                {
                    ...
                    b.Property<uint>("MaxTwitcastingSpiderCount")
                        ...
                        .HasColumnName("max_twitcasting_spider_count");

                    b.Property<uint>("MaxTwitchSpiderCount")
                        .HasColumnType("int unsigned")
                        .HasColumnName("max_twitch_spider_count");

                    b.Property<uint>("MaxTwitterSpaceSpiderCount")
                        .HasColumnType("int unsigned")
                        .HasColumnName("max_twitter_space_spider_count");

                    b.Property<uint>("MaxYouTubeMemberCheckCount")
                        .HasColumnType("int unsigned")
                        .HasColumnName("max_you_tube_member_check_count");

                    b.Property<uint>("MaxYouTubeSpiderCount")
                        .HasColumnType("int unsigned")
                        .HasColumnName("max_you_tube_spider_count");
            ...
            modelBuilder.Entity("Discord_Stream_Notify_Bot.DataBase.Table.HoloVideos", b =>
                {
            ...
            modelBuilder.Entity("Discord_Stream_Notify_Bot.DataBase.Table.NijisanjiVideos", b =>
                {
                    b.Property<string>("VideoId")
                        .HasColumnType("varchar(255)")
                        .HasColumnName("video_id");
            ...
            modelBuilder.Entity("Discord_Stream_Notify_Bot.DataBase.Table.NonApprovedVideos", b =>
                {
                    b.Property<string>("VideoId")
                        .HasColumnType("varchar(255)")
                        .HasColumnName("video_id");
            ...
            modelBuilder.Entity("Discord_Stream_Notify_Bot.DataBase.Table.OtherVideos", b =>
                {
                    b.Property<string>("VideoId")
                        .HasColumnType("varchar(255)")
                        .HasColumnName("video_id");
            ...
            modelBuilder.Entity("Discord_Stream_Notify_Bot.DataBase.Table.TwitterSpaceSpider", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("varchar(255)")
                        .HasColumnName("user_id");
