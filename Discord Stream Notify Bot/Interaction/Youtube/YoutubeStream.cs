...
namespace Discord_Stream_Notify_Bot.Interaction.Youtube
{
    public partial class YoutubeStream : TopLevelModule<SharedService.Youtube.YoutubeStreamService>
    {
        ...
        //[SlashCommand("right-now-record","馬上錄影")]
        //public async Task RightNowRecordStream([Summary("直播Id")] string videoId)
        //{
        //    try
        //    {
        ...
        //    catch (Exception)
        //    {
        //        await Context.Interaction.SendConfirmAsync("VideoId錯誤，請確認是否輸入正確的網址", true).ConfigureAwait(false);
        //        return;
        //    }

        //    if (videoId.Length != 11)
        //    {
        //        await Context.Interaction.SendConfirmAsync("VideoId錯誤錯誤，需為11字數", true).ConfigureAwait(false);
        //        return;
        //    }

        //    var nowRecordStreamList = Discord_Stream_Notify_Bot.Utility.GetNowRecordStreamList();

        //    if (nowRecordStreamList.ContainsKey(videoId))
        //    {
        //        await Context.Interaction.SendConfirmAsync($"{videoId} 已經在錄影了", true).ConfigureAwait(false);
        //        return;
        //    }
        ...
        //    if (video == null)
        //    {
        //        await Context.Interaction.SendConfirmAsync($"{videoId} 不存在", true).ConfigureAwait(false);
        //        return;
        //    }
        ...
        //        await Context.Interaction.SendConfirmAsync("已開始錄影", description, true).ConfigureAwait(false);
        //    else
        //        await Context.Interaction.SendConfirmAsync($"Redis錯誤，請確認後端狀態", true).ConfigureAwait(false);
        //}

        //[RequireOwner]
        //[DefaultPermission(false)]
        //[RequireContext(ContextType.Guild)]
        //[SlashCommand("add-record-channel", "新增直播記錄頻道")]
        //public async Task AddRecordChannel([Summary("頻道Id")] string channelId)
        //{
        //    if (!channelId.Contains("UC"))
        //    {
        //        await Context.Interaction.SendConfirmAsync("頻道Id錯誤", true).ConfigureAwait(false);
        //        return;
        //    }
        ...
        //    catch
        //    {
        //        await Context.Interaction.SendConfirmAsync("頻道Id格式錯誤，需為24字數", true).ConfigureAwait(false);
        //        return;
        //    }
        ...
        //        {
        //            await Context.Interaction.SendConfirmAsync($"{channelId} 已存在於直播記錄清單", true);
        //            return;
        //        }
        ...
        //        if (channelTitle == "")
        //        {
        //            await Context.Interaction.SendConfirmAsync($"頻道 {channelId} 不存在", true).ConfigureAwait(false);
        //            return;
        //        }
        ...
        //        await Context.Interaction.SendConfirmAsync($"已新增 {channelTitle} 至直播記錄清單", true).ConfigureAwait(false);
        //    }
        //}
        ...
        //[DefaultPermission(false)]
        //[RequireContext(ContextType.Guild)]
        //[SlashCommand("remove-record-channel", "移除直播記錄頻道")]
        //public async Task RemoveRecordChannel([Summary("頻道Id")] string channelId)
        //{
        //    if (!channelId.Contains("UC"))
        //    {
        ...
        //        if (!db.RecordYoutubeChannel.Any((x) => x.YoutubeChannelId == channelId))
        //        {
        //            await Context.Interaction.SendConfirmAsync($"直播記錄清單中沒有 {channelId}").ConfigureAwait(false);
        //            return;
        //        }
        ...
        //        await db.SaveChangesAsync();
        //        await Context.Interaction.SendConfirmAsync($"已從直播記錄清單中移除 {channelTitle}").ConfigureAwait(false);
        //    }
        //}
